...
def find_missing_wikidata_iso():
    wikidata_file = "databaseCollector/cleaned_query_1.json"
    iso_file = "CrossRefrenceData/ISO 639-3/filtered_iso_data.json"
    output_file = "databaseCollector/pull_all_wikidata_missing_ids"
...
def clean_missing_data(lang_data):
    ...
    with open("databaseCollector/debug/ethnic_groups.json", "r", encoding="utf-8") as f:
...
def filter_lang_data(lang_data):
    ...
    with open("databaseCollector/debug/languages.json", "w", encoding="utf-8") as f:
    ...
    with open("databaseCollector/debug/dialects.json", "w", encoding="utf-8") as f:
        json.dump(dialects_data, f, indent=4, ensure_ascii=False)

    # all sign lagnuages
    print("Length of sign language list: ")
    print(len(signlang_data))
    with open("databaseCollector/debug/signlanguage.json", "w", encoding="utf-8") as f:
    ...
    with open("databaseCollector/debug/lang_missing_everything.json", "w", encoding="utf-8") as f:
