...
def main():
    fname = os.path.isfile("databaseCollector/debug/langmetadata.json")
    if fname:
        ...
        if refetch_me == "y":
            ...
            with open("databaseCollector/debug/langmetadata.json", "r", encoding="utf-8") as f:
    ...
    if repopulate_regiondata == "y":
        ...
        with open("databaseCollector/debug/minifiedFormattedRegionData.geojson", "r", encoding="utf-8") as f:
